"""
train_attention_standalone.py
-----------------------------
AttentionUNet'i 30 epoch boyunca eğitir (CSV kaydı ile).

Kaydedilen dosyalar:
  results/models/attention_unet_best.pth
  results/models/attention_unet_last.pth
  results/logs/attention_unet_history.csv
"""
